...
__all__ = ['plot_trainings', 'arrange_shape', 'best_so_far', 'plot_exploration', 'convergence_time',
           'indiv_convergence_time', 'get_indiv_times', 'CPU_Unpickler', 'get_problem_file_name', 'get_agent_file_name',
           'get_memory_file_name', 'get_benchmark_file_name', 'get_checkpoint_file_name', 'save_model', 'load_model',
           'save_benchmark', 'load_benchmark', 'load_checkpoint', 'checkpoint2results', 'bench_dir', 'ckp_dir',
           'agents_dir', 'simplify_layout', 'fill_layout', 'state2int', 'state2str', 'T', 'flip', 'add_subgraph_size',
